...
a1_orig = np.load('./curves/1_orig.npy')
a1_attack = np.load('./curves/1_attack.npy')
plt.plot(a1_orig,'b')
plt.plot(a1_attack,'r')
plt.show()

a3_orig = np.load('./curves/3_orig.npy')
a3_attack = np.load('./curves/3_attack.npy')
plt.plot(a3_orig,'b')
plt.plot(a3_attack,'r')
plt.show()
