...
tf.flags.DEFINE_integer(
    'num_iter', 20, 'How many images process at one time.')
...
EOT=0
ALPHA_FACTOR=FLAGS.alpha

print('ITER_NUM small = {0}'.format(ITER_NUM))
print('ITER_NUM large = {0}'.format(ITER_NUM * 2))
...
def save_images(images, filenames, output_dir):
  ...
  for i, filename in enumerate(filenames):
    ...
    filename = 'momentum'+ get_file_config() + filename + r'.png'
